        ...
        for key in object_list:
            ...
            if (key.get('positionSide') =='LONG' and (key.get('symbol') == "BNBUSD_PERP")):
                ...
                if (float(positionAmtLong) >= 0):
                    ...
                    if ((obv_bnb ==2 and sweat_bnb ==2) and (float(positionAmtShort) >= 0) and (float(positionAmtShort) < 30)):
                        Up = True
                        Down = False
                        print("Up",Up)
                        time.sleep(1)
                        ...
                        time.sleep(1)
                    elif ((obv_bnb ==2 and sweat_bnb ==2) and (float(positionAmtShort) >= 30) ):
                        Up = True
                        Down = False
                        print("Up",Up)
                        time.sleep(1)
        ...
        for keys in object_list:
            ...
            if (keys.get('positionSide') =='SHORT' and (keys.get('symbol') == "BNBUSD_PERP")):
                ...
                if (float(positionAmtShort) >= 0):
                    ...
                    if ((obv_bnb ==1 and sweat_bnb ==1) and (float(positionAmtLong) >= 0) and (float(positionAmtLong) < 30)):
                        Down = True
                        Up = False
                        ...
                        time.sleep(1)
                    elif ((obv_bnb ==1 and sweat_bnb ==1) and (float(positionAmtLong) >= 30)):
                        Down = True
                        Up = False
