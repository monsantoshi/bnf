...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            #     if ((keys.get('positionSide') =='SHORT') and (keys.get('symbol') == "BNBUSD_PERP") and (keys.get('side') == "BUY")):
            ...
            for keys in object_list_open:
                if ((keys.get('positionSide') =='SHORT') and (keys.get('symbol') == "BNBUSD_PERP") and (keys.get('type')=="LIMIT") and (keys.get('status')=="NEW") and (keys.get('side') == "BUY")):
                    markets = keys.get('symbol')
                    orderIds = keys.get('orderId')
                        ...
                        if (mPrices <= Decimal(psff) and mPrices > Decimal(psfff) ):
                            ...
                            #while True:
                                ...
                                for keyi in object_list_in:
                                    if (keyi.get('positionSide') =='SHORT' and keyi.get('symbol') =='BNBUSD_PERP' and keyi.get('positionAmt') < 0.0):
