...
def check_buy_sell_signals(df):
    ...
    #         close_order_buy_coin(self,'ADAUSD_PERP')  
    #         #in_position = False
    #         message = f"CLOSE POSITION LONG ADAUSD"
    ...
    #         #order = exchange.create_market_buy_order('ETH/USD', 0.05)
    #     #order = exchange.create_order(symbol='adausdt', side=OrderSide.BUY,positionSide=PositionSide.LONG, ordertype=OrderType.MARKET,  quantity=1)
    #         close_order_sell_coin(self,'ADAUSD_PERP')  
    #         #in_position = False
    #         message = f"CLOSE POSITION SHORT ADAUSD"
...
def run_bot():
    ...
    bars = exchange.fetch_ohlcv("ADAUSD_PERP", timeframe='3m', limit=100)
    ...
    # bars = request_client.get_candlestick_data(symbol="ADAUSD_PERP", interval=CandlestickInterval.MIN3,startTime=None, endTime=None, limit=100)
