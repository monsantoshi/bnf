                ...
                if (key.get('positionSide') =='SHORT' and key.get('positionAmt') < 0.0):
                    ...
                    try:
                        if  ((priceIns > 3000)):
                            ...
                            ps = str(round(float(priceIns) -((0.02* float(priceIns))/20),2))
                            psf = str(round(float(priceIns) -((0.02* float(priceIns))/20),2))
                            ...
                            ps = str(round(float(priceIns) -((0.02* float(priceIns))/20),3))
                            psf = str(round(float(priceIns) -((0.02* float(priceIns))/20),3))
                            ...
                            ps = str(round(float(priceIns) -((0.02* float(priceIns))/20),5))

                            psf = str(round(float(priceIns) -((0.02* float(priceIns))/20),5))
                            ...
                            ps = str(round(float(priceIns) -((0.02* float(priceIns))/20),6))
                            psf = str(round(float(priceIns) -((0.02* float(priceIns))/20),6))
