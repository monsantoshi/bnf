...
def check_buy_sell_signals(df):
    ...
    #         close_order_buy_coin_usdt(self,'WAVESUSDT')  
    #         in_position = False
    #         message = f"CLOSE POSITION LONG WAVESUSDT"
    ...
    #         #order = exchange.create_market_buy_order('ETH/USD', 0.05)
    #     #order = exchange.create_order(symbol='adausdt', side=OrderSide.BUY,positionSide=PositionSide.LONG, ordertype=OrderType.MARKET,  quantity=1)
    #         close_order_sell_coin_usdt(self,'WAVESUSDT')  
    #         in_position = False
    #         message = f"CLOSE POSITION SHORT WAVESUSDT"
...
def run_bot():
    ...
    # bars = exchange.fetch_ohlcv('WAVESUSDT', timeframe='5m', limit=140)
    ...
    bars = request_client.get_candlestick_data(symbol="WAVESUSDT", interval=CandlestickInterval.MIN3,startTime=None, endTime=None, limit=100)
