...
class calculate_signal:
    ...
    def supertrend(df,market, period=7, atr_multiplier=3):
        request_client = RequestClientD(api_key=g_api_key, secret_key=g_secret_key)        
        ...
        if (priceMax) > (priceMin):
            ...
            if (priceMax) < (priceMin) or (haha) == 5:
    ...
    #time.sleep(10)
        ...
        for current in range(1, len(df.index)):
            ...
            elif df['in_uptrendEW'][current]==11: 
