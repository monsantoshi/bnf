            ...
            if (key.get('positionSide') =='LONG' and (key.get('symbol') == "ALPHAUSDT")):
                ...
                if (float(positionAmtLong) == 0):
                    ...
                    if ((dark_alpha+obv_alpha+sweat_alpha) <3):
                        ...
                        sweat_alpha = 2
                        time.sleep(1)
                    elif ((dark_alpha+obv_alpha+sweat_alpha) ==3):
                        Up = False
                        Down = True
                        print("TP_LONG",True)
                        time.sleep(1)
                        print("take_profit_long")
                        take_order_long = request_client.post_order(symbol="ALPHAUSDT", side=OrderSide.BUY,positionSide=PositionSide.LONG, ordertype=OrderType.LIMIT, price=p, quantity=a,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_long)
                        # update_obv("2",'ALPHAUSDT')
                        # update_dark("2",'ALPHAUSDT')
                        # update_sweat("2",'ALPHAUSDT')
            ...
            if (keys.get('positionSide') =='SHORT' and (keys.get('symbol') == "ALPHAUSDT")):
                ...
                if (float(positionAmtShort) == 0):
                    ...
                    if ((dark_alpha+obv_alpha+sweat_alpha) > 0 and (dark_alpha+obv_alpha+sweat_alpha) <3):
                        ...
                        time.sleep(1)
                    elif ((dark_alpha+obv_alpha+sweat_alpha) == 0):
                        Down = False
                        Up = True
                        ...
                        take_order_short = request_client.post_order(symbol="ALPHAUSDT", side=OrderSide.SELL,positionSide=PositionSide.SHORT, ordertype=OrderType.LIMIT, price=ps, quantity=ass,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_short)
                        # update_obv("2",'ALPHAUSDT')
                        # update_dark("2",'ALPHAUSDT')
                        # update_sweat("2",'ALPHAUSDT')
            ...
            if (key.get('positionSide') =='LONG' and (key.get('symbol') == "SXPUSDT")):
                ...
                if (float(positionAmtLong) == 0):
                    ...
                    if ((dark_sxp+obv_sxp+sweat_sxp) <3):
                        ...
                        time.sleep(1)
                    elif ((dark_sxp+obv_sxp+sweat_sxp) ==3):
                        Up = False
                        Down = True
                        print("TP_LONG",True)
                        time.sleep(1)
                        print("take_profit_long")
                        take_order_long = request_client.post_order(symbol="SXPUSDT", side=OrderSide.BUY,positionSide=PositionSide.LONG, ordertype=OrderType.LIMIT, price=p, quantity=a,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_long)
                        #update_obv("2",'SXPUSDT')
                        #update_dark("2",'SXPUSDT')
                        #update_sweat("2",'SXPUSDT')
            ...
            if (keys.get('positionSide') =='SHORT' and (keys.get('symbol') == "SXPUSDT")):
                ...
                if (float(positionAmtShort) == 0):
                    ...
                    if ( (dark_alpha+obv_alpha+sweat_alpha) > 0 and (dark_alpha+obv_alpha+sweat_alpha) <3):
                        ...
                        take_order_short = request_client.post_order(symbol="SXPUSDT", side=OrderSide.SELL,positionSide=PositionSide.SHORT, ordertype=OrderType.LIMIT, price=ps, quantity=ass,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_short)
                        #update_obv("2",'SXPUSDT')
                        #update_dark("2",'SXPUSDT')
                        #update_sweat("2",'SXPUSDT')
            ...
            if (key.get('positionSide') =='LONG' and (key.get('symbol') == "GRTUSDT")):
                ...
                if (float(positionAmtLong) == 0):
                    ...
                    if ((dark_grt+ obv_grt+sweat_grt) <3):
                        ...
                        time.sleep(1)                    
                    elif ((dark_grt+ obv_grt+sweat_grt) ==3):
                        Up = False
                        Down = True
                        print("TP_LONG",True)
                        time.sleep(1)
                        print("take_profit_long")
                        take_order_long = request_client.post_order(symbol="GRTUSDT", side=OrderSide.BUY,positionSide=PositionSide.LONG, ordertype=OrderType.LIMIT, price=p, quantity=a,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_long)
                        #update_obv("2",'SXPUSDT')
                        #update_dark("2",'SXPUSDT')
                        #update_sweat("2",'SXPUSDT')
            ...
            if (keys.get('positionSide') =='SHORT' and (keys.get('symbol') == "GRTUSDT")):
                ...
                if (float(positionAmtShort) == 0):
                    ...
                    if ((dark_grt+ obv_grt+sweat_grt) > 0 and (dark_grt+ obv_grt+sweat_grt) <3):
                        ...
                        time.sleep(1)
                    elif ((dark_grt+ obv_grt+sweat_grt) == 0):
                        Down = False
                        Up = True
                        ...
                        take_order_short = request_client.post_order(symbol="GRTUSDT", side=OrderSide.SELL,positionSide=PositionSide.SHORT, ordertype=OrderType.LIMIT, price=ps, quantity=ass,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_short)
                        #update_obv("2",'SXPUSDT')
                        #update_dark("2",'SXPUSDT')
                        #update_sweat("2",'SXPUSDT')
            ...
            if (key.get('positionSide') =='LONG' and (key.get('symbol') == "ADAUSDT")):
                ...
                if (float(positionAmtLong) == 0):
                    ...
                    if ( (dark_ada+ obv_ada+sweat_ada) <3):
                        ...
                        time.sleep(1)
                    elif ( (dark_ada+ obv_ada+sweat_ada) ==3):
                        ...
                        time.sleep(1)
                        print("take_profit_long")
                        take_order_long = request_client.post_order(symbol="ADAUSDT", side=OrderSide.BUY,positionSide=PositionSide.LONG, ordertype=OrderType.LIMIT, price=p, quantity=a,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_long)
                        # update_obv("2",'ADAUSDT')
                        # update_dark("2",'ADAUSDT')
                        # update_sweat("2",'ADAUSDT')
            ...
            if (keys.get('positionSide') =='SHORT' and (keys.get('symbol') == "ADAUSDT")):
                ...
                if (float(positionAmtShort) == 0):
                    ...
                    if ((dark_ada+ obv_ada+sweat_ada) > 0 and (dark_ada+ obv_ada+sweat_ada) <3):
                        ...
                        time.sleep(1)
                    elif ((dark_ada+ obv_ada+sweat_ada) == 0 ):
                        Down = False
                        Up = True
                        ...
                        take_order_short = request_client.post_order(symbol="ADAUSDT", side=OrderSide.SELL,positionSide=PositionSide.SHORT, ordertype=OrderType.LIMIT, price=ps, quantity=ass,timeInForce='GTC')
                        PrintBasic.print_obj(take_order_short)
                        # update_obv("2",'ADAUSDT')
                        # update_dark("2",'ADAUSDT')
                        # update_sweat("2",'ADAUSDT')
