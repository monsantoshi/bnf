            ...
            for key in object_list:
                if (key.get('positionSide') =='LONG' and key.get('positionAmt') > 0.0):
                    ...
                    try:
                        ...
                        if  ((priceIn > 3000)):
                            print("""""""""""""""""""""""")
                            p = str(round(float(priceIn) +((0.025* float(priceIn))/20),2))
                            pf = str(round(float(priceIn) +((0.025* float(priceIn))/20),2))
                            ...
                            pf = str(round(float(priceIn) +((0.025* float(priceIn))/20),3))
                            ...
                            pf = str(round(float(priceIn) +((0.025* float(priceIn))/20),5))
                            ...
                            p = str(round(float(priceIn) +((0.025* float(priceIn))/20),6))
                            pf = str(round(float(priceIn) +((0.025* float(priceIn))/20),6))
