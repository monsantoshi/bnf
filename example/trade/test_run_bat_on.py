...
if __name__ == '__main__':
    ...
    try:
        while True:    
            ...
            sa = subprocess.Popen(['schtasks.exe', '/End', '/TN', 'binance_get_alert'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            saa = subprocess.Popen(['schtasks.exe', '/End', '/TN', 'binance_try_kill'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            saaa = subprocess.Popen(['schtasks.exe', '/End', '/TN', 'binance_try_bat_rerun'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            sba = subprocess.Popen(['schtasks.exe', '/End', '/TN', 'binance_try_kill_con'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            time.sleep(1)
            ra = subprocess.Popen(['schtasks.exe', '/Run', '/TN', 'binance_get_alert'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            time.sleep(1)
            raa = subprocess.Popen(['schtasks.exe', '/Run', '/TN', 'binance_try_kill'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            time.sleep(1)
            raaa = subprocess.Popen(['schtasks.exe', '/Run', '/TN', 'binance_try_bat_rerun'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            time.sleep(1)
            rba = subprocess.Popen(['schtasks.exe', '/Run', '/TN', 'binance_try_kill_con'],stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            time.sleep(300)            
