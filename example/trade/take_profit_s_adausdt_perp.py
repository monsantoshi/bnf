    ...
    try:
        while True:
            ...
            for keys in object_list_open:
                if ((keys.get('positionSide') =='SHORT') and (keys.get('symbol') == "ADAUSDT") and (keys.get('type')=="LIMIT") and (keys.get('status')=="NEW") and (keys.get('side') == "BUY")):
...
###########################
            ...
            for key in object_list:
                ...
                f.close()
                if (key.get('positionSide') =='SHORT' and key.get('symbol') =='ADAUSDT' and key.get('positionAmt') < 0.0):
                    syms = key.get('symbol')
                        ...
                        if (mPrices <= Decimal(psff) and mPrices > Decimal(psfff) ):
                            ...
                            #while True:
                                ...
                                for keyi in object_list_in:
                                    if (keyi.get('positionSide') =='SHORT' and keyi.get('symbol') =='ADAUSDT' and keyi.get('positionAmt') < 0.0):
