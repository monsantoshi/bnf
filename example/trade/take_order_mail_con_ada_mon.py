...
class CountCandle:
    ...
    def take_order_point(self):
        ...
        #             if ((dark_bnb ==2 and obv_bnb ==2 and sweat_bnb ==2) and (float(positionAmtShort) >= 0) and (float(positionAmtShort) < 30)):
        #                 Up = True
        #                 Down = False
        #                 print("Up",Up)
        #                 time.sleep(1)
        ...
        #                 time.sleep(1)
        #             elif ((dark_bnb ==2 and obv_bnb ==2 and sweat_bnb ==2) and (float(positionAmtShort) >= 30) ):
        #                 Up = True
        #                 Down = False
        #                 print("Up",Up)
        #                 time.sleep(1)
        ...
        #             if ((dark_bnb+obv_bnb+sweat_bnb) > 0 and (dark_bnb+obv_bnb+sweat_bnb) < 6 ):
        #                 Up = False
        #                 Down = True
        #                 print("TP_LONG",True)
        #                 time.sleep(1)
        ...
        #                 sweat_bnb = 0
        #                 time.sleep(1)
        #             elif ((dark_bnb+obv_bnb+sweat_bnb) ==6 and (float(a) < float(step_two_unitbc))):
        #                 Up = False
        #                 Down = True
        #                 print("TP_LONG",True)
        #                 time.sleep(1)
        ...
        #             # sweat = ltc_data["sweat"]
        #             # if ((dark =="1" and obv =="1" and sweat =="1")):
        #             if ((dark_bnb ==2 and obv_bnb ==2 and sweat_bnb ==2)):
        #                 Up = True
        #                 Down = False
        #                 print("Up",Up)
        #                 time.sleep(1)
        ...
        #             if ((dark_bnb ==1 and obv_bnb ==1 and sweat_bnb ==1) and (float(positionAmtLong) >= 0) and (float(positionAmtLong) < 30)):
        #                 Down = True
        #                 Up = False
        ...
        #                 time.sleep(1)
        #             elif ((dark_bnb ==1 and obv_bnb ==1 and sweat_bnb ==1) and (float(positionAmtLong) >= 30)):
        #                 Down = True
        #                 Up = False
        ...
        #                 time.sleep(1)
        #             elif ((dark_bnb+obv_bnb+sweat_bnb) == 3 and (float(ass) < float(step_two_unitbc))):
        #                 Down = False
        #                 Up = True
        ...
        for key in object_list:
            ...
            if (key.get('positionSide') =='LONG' and (key.get('symbol') == "ADAUSD_PERP")):
                ...
                if (float(positionAmtLong) == 0):
                    ...
                    # sweat = ltc_data["sweat"]
                    # if ((dark =="1" and obv =="1" and sweat =="1")):
                    if ((dark_adad ==2 and obv_adad ==2 and sweat_adad ==2 and guide_ada ==2) and (float(positionAmtShort) >= 0) and (float(positionAmtShort) < 30)):
                        Up = True
                        Down = False
                        print("Up",Up)
                        time.sleep(1)
                        ...
                        time.sleep(1)
                    elif ((dark_adad ==2 and obv_adad ==2 and sweat_adad ==2 and guide_ada ==2) and (float(positionAmtShort) >= 30) ):
                        Up = True
                        Down = False
                        print("Up",Up)
                        time.sleep(1)
                    ...
                    # sweat = ltc_data["sweat"]
                    # if ((float(dark)+float(obv)+float(sweat)) <3):
                    if ((dark_adad+obv_adad+sweat_adad) >=1 and (dark_adad+obv_adad+sweat_adad) <6):
                        Up = False
                        Down = True
                        print("TP_LONG",True)
                        time.sleep(1)
                        ...
                        #guide_ada = 0 
                        time.sleep(1)
                    elif ((dark_adad+obv_adad+sweat_adad) ==6 and guide_ada == 2 and (float(a) < float(step_two_unitbc))):
                        Up = False
                        Down = True
                        print("TP_LONG",True)
                        time.sleep(1)
                    ...
                    # sweat = ltc_data["sweat"]
                    # if ((dark =="1" and obv =="1" and sweat =="1")):
                    if ((dark_adad ==2 and obv_adad ==2 and sweat_adad ==2 and guide_ada == 2)):
                        Up = True
                        Down = False
                        print("Up",Up)
                        time.sleep(1)
        ...
        for keys in object_list:
            ...
            if (keys.get('positionSide') =='SHORT' and (keys.get('symbol') == "ADAUSD_PERP")):
                ...
                if (float(positionAmtShort) == 0):
                    ...
                    # sweat = ltc_data["sweat"]
                    # if ((dark =="0" and obv =="0" and sweat =="0")):
                    if ((dark_adad ==1 and obv_adad ==1 and sweat_adad ==1 and guide_ada ==1) and (float(positionAmtLong) >= 0) and (float(positionAmtLong) < 30)):
                        Down = True
                        Up = False
                        ...
                        time.sleep(1)
                    elif ((dark_adad ==1 and obv_adad ==1 and sweat_adad ==1 and guide_ada == 1) and (float(positionAmtLong) >= 30)):
                        Down = True
                        Up = False
                    ...
                    if ((dark_adad+obv_adad+sweat_adad) >= 3):
                        ...
                        time.sleep(1)
                    elif ((dark_adad ==1 and obv_adad ==1 and sweat_adad ==1 and guide_ada == 1) and (float(ass) < float(step_two_unitbc)) and (float(mPrices) >= float(pss))):
                        Down = False
                        Up = True
                    ...
                    # sweat = ltc_data["sweat"]
                    # if ((dark =="0" and obv =="0" and sweat =="0")):
                    if ((dark_adad ==1 and obv_adad ==1 and sweat_adad ==1 and guide_ada == 1)):
                        Down = True
                        Up = False
