...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            #     if ((key.get('positionSide') =='LONG') and key.get('symbol') =='BNBUSD_PERP' and (key.get('side') == "SELL")):
            ...
            for keys in object_list_open:
                #cont = 0
                if ((keys.get('positionSide') =='LONG') and (keys.get('symbol') == "BNBUSD_PERP")  and (keys.get('type')=="LIMIT") and (keys.get('status')=="NEW") and (keys.get('side') == "SELL")):
            ...
            for key in object_list:
                ...
                f.close()
                if (key.get('positionSide') =='LONG' and key.get('symbol') =='BNBUSD_PERP' and key.get('positionAmt') > 0.0):
                    sym = key.get('symbol')
                    ...
                    try:
                        ...
                        pf = str(round(float(priceIn) +((1.00* float(priceIn))/20),3))
                        ...
                        if (mPrice >= Decimal(ploss) and float(a) > 0 ):
                            ...
                            #         conts = 0
                            # except IndexError as error:
                            #     print("Exiting: with error in try1" + "\n")
                            # except Exception as exception:
                            #     print("Exiting: Exception error in try1" +  "\n")  
