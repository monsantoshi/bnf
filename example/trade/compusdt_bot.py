...
def check_buy_sell_signals(df):
    ...
    #         close_order_buy_coin_usdt(self,'COMPUSDT')  
    #         in_position = False
    #         message = f"CLOSE POSITION LONG COMPUSDT"
    ...
    #         #order = exchange.create_market_buy_order('ETH/USD', 0.05)
    #     #order = exchange.create_order(symbol='adausdt', side=OrderSide.BUY,positionSide=PositionSide.LONG, ordertype=OrderType.MARKET,  quantity=1)
    #         close_order_sell_coin_usdt(self,'COMPUSDT')  
    #         in_position = False
    #         message = f"CLOSE POSITION SHORT COMPUSDT"
...
def run_bot():
    ...
    bars = exchange.fetch_ohlcv('COMPUSDT', timeframe='5m', limit=100)
