...
def take_order_sell(self):
    ...
    count_s = alpha_data["count_ss"]
    
    limit_s = alpha_data["limit_ss"]
    count_l = alpha_data["count_ll"]
    
    limit_l = alpha_data["limit_ll"]
    reentryunit = str(round(float(alpha_data["reentry_units"]),4))
...
def inc_count_s(count):
    ...
    collection_alpha.update_one({"market": 'ALPHAUSDT'},{"$set":{"count_ss":count_ss} })
...
def cls_count_s(count):
    ...
    if (count_ll > 5):
        collection_alpha.update_one({"market": 'ALPHAUSDT'},{"$set":{"count_ss":count} })
...
def inc_count_l(count):
    ...
    collection_alpha.update_one({"market": 'ALPHAUSDT'},{"$set":{"count_ll":count_ll} })
    #if (count_l > limit_l+1):
        #count_ss = count_s + count
        #collection_alpha.update_one({"market": 'ALPHAUSDT'},{"$set":{"count_ll":0} })
...
def cls_count_l(count):
    ...
    if (count_ss > 5):
        collection_alpha.update_one({"market": 'ALPHAUSDT'},{"$set":{"count_ll":count} })
    return
...
##    step_seven_unit = alpha_data["step_seven_unit"]
    ...
    reentry_unit = alpha_data["reentry_units"]
